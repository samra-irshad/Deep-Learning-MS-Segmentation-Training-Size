...
if __name__ == '__main__':
    ...
    baseline = baseline[0:training_set_size]
    ...
    train_set, val_set, test_set = baseline[0:floor(l_baseline * train_part)]\
        , baseline[floor(l_baseline * train_part): floor(l_baseline * (train_part + val_part) )]\
        ,  baseline[floor(l_baseline * (train_part + val_part)): floor(floor(l_baseline * (train_part + val_part + test_part)))]
